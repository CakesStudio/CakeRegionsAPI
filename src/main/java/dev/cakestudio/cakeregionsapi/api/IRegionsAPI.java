...
public interface IRegionsAPI {
    ...
    com.tcoded.folialib.FoliaLib getFoliaLib();
    void registerCommand(@NonNull Object command);
    void unregisterCommand(@NonNull Object command);
    java.io.File getDataFolder();

    @NotNull dev.cakestudio.cakeregionsapi.api.manager.economy.IEconomyManager getEconomyManager();
    @NotNull dev.cakestudio.cakeregionsapi.api.manager.item.IItemHookManager getItemHookManager();
